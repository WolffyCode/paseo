...
const PASSTHROUGH_DISPATCH: Record<string, KeyboardActionDefinition> = {
  ...
  "workspace.review.open": { id: "workspace.review.open", scope: "workspace" },
  "workspace.file.open": { id: "workspace.file.open", scope: "workspace" },
  "workspace.side-chat.open": { id: "workspace.side-chat.open", scope: "workspace" },
  "workspace.tool-panel.toggle": { id: "workspace.tool-panel.toggle", scope: "workspace" },
