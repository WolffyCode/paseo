...
const en: ShellMessages = {
  ...
  "shell.conversation.empty": "Select a conversation",
  "shell.conversation.noWorkspace": "This conversation has no working directory",
  "shell.conversation.selectDirectory": "Select working directory",
  "shell.conversation.directoryPlaceholder": "Search projects or enter a host path",
  "shell.conversation.directoryOpening": "Opening directory...",
  "shell.conversation.directoryEmpty": "No matching project directories",
  "shell.conversation.directoryOpenPath": "Open path",
  "shell.conversation.directoryOpenFailed": "Could not open working directory.",
  "shell.conversation.projects": "Projects",
  "shell.conversation.filesystem": "File system",
  "shell.conversation.filesystemPlaceholder": "Enter a host path to browse",
  "shell.conversation.filesystemLoading": "Loading folders...",
  "shell.conversation.filesystemEmpty": "No subfolders in this directory",
  "shell.conversation.chooseCurrentDirectory": "Choose this folder",
  "shell.conversation.parentDirectory": "Go to parent directory",
  "shell.conversation.filesystemUnavailable": "File system unavailable",
  "shell.conversation.conversationOnly": "Conversation · no working directory",
...
const zhCN: ShellMessages = {
  ...
  "shell.conversation.empty": "选择一个对话",
  "shell.conversation.noWorkspace": "此对话未选择工作目录",
  "shell.conversation.selectDirectory": "选择工作目录",
  "shell.conversation.directoryPlaceholder": "搜索项目或输入 Host 路径",
  "shell.conversation.directoryOpening": "正在打开目录...",
  "shell.conversation.directoryEmpty": "没有匹配的项目目录",
  "shell.conversation.directoryOpenPath": "打开路径",
  "shell.conversation.directoryOpenFailed": "无法打开工作目录。",
  "shell.conversation.projects": "项目目录",
  "shell.conversation.filesystem": "文件系统",
  "shell.conversation.filesystemPlaceholder": "输入 Host 路径浏览文件系统",
  "shell.conversation.filesystemLoading": "正在加载文件夹...",
  "shell.conversation.filesystemEmpty": "当前目录没有子文件夹",
  "shell.conversation.chooseCurrentDirectory": "选择此目录",
  "shell.conversation.parentDirectory": "返回上级目录",
  "shell.conversation.filesystemUnavailable": "文件系统不可用",
  "shell.conversation.conversationOnly": "对话 · 未选择工作目录",
