...
const en: ShellMessages = {
  ...
  "shell.conversation.noWorkspace": "Open a project before starting a conversation",
  "shell.conversation.selectDirectory": "Select working directory",
  "shell.conversation.directoryPlaceholder": "Type a directory path...",
  "shell.conversation.directoryOpening": "Opening directory...",
  "shell.conversation.directoryEmpty": "Start typing a path",
...
const zhCN: ShellMessages = {
  ...
  "shell.conversation.noWorkspace": "请先打开项目，再开始新对话",
  "shell.conversation.selectDirectory": "选择工作目录",
  "shell.conversation.directoryPlaceholder": "输入目录路径...",
  "shell.conversation.directoryOpening": "正在打开目录...",
  "shell.conversation.directoryEmpty": "开始输入路径",
