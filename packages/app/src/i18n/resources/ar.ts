...
export const ar: TranslationResources = {
  ...
  settings: {
    ...
    vendors: {
      ...
      edit: {
        ...
        models: {
          sectionTitle: "النماذج · أيها تعرض",
          sectionSubtitle: "النماذج المحددة فقط تظهر في محدد المحادثة",
          fetchButton: "⤓ جلب قائمة النماذج",
          searchPlaceholder: "🔍 بحث",
          fetchError: "فشل الجلب: {{reason}}",
          fetchErrorManualHint: "يمكنك إضافة النماذج يدويًا.",
          manualAddPlaceholder: "معرف النموذج",
          manualAddButton: "＋",
          manualAddAccessibilityLabel: "إضافة نموذج",
          setDefault: "تعيين كافتراضي",
          isDefault: "● افتراضي",
          exposedCountFooter: "تم عرض {{exposed}} / {{total}} نموذج",
        },
  ...
  conversation: {
    modelPicker: {
      directConnect: "مباشر · Anthropic الرسمي",
      providerLocked: "🔒 مقفل",
      noModel: "لا نموذج",
      providerSection: "① المزود · مقفل",
      vendorSection: "② البائع · قابل للتبديل",
