...
export const ar: TranslationResources = {
  ...
  composer: {
    placeholders: {
      desktop: "صف المهمة أو استخدم /commands و /skills",
      mobile: "أرسل رسالة أو استخدم /commands",
      fallback: "رسالة...",
    },
    input: {
    ...
    runtimeConfig: { label: "إعداد التشغيل" },
    workspace: { locked: "مقفل" },
    cancel: {
    ...
    attachments: {
      ...
      queued: "في الانتظار",
      deleteQueuedAction: "حذف",
      forceSendQueuedAction: "إرسال الآن",
      editQueuedMessage: "تحرير الرسالة في قائمة الانتظار",
      deleteQueuedMessage: "حذف الرسالة في قائمة الانتظار",
      sendQueuedMessageNow: "فرض إرسال الرسالة في قائمة الانتظار",
  ...
  sidebar: {
    ...
    conversation: {
      selectDirectory: "اختيار دليل العمل",
      directoryPlaceholder: "ابحث عن المشاريع أو أدخل مسار المضيف",
      directoryOpening: "جار فتح الدليل...",
      directoryEmpty: "لا توجد أدلة مشاريع مطابقة",
      directoryOpenPath: "فتح المسار",
      directoryOpenFailed: "تعذر فتح الدليل",
      projects: "المشاريع",
      filesystem: "نظام الملفات",
      filesystemPlaceholder: "أدخل مسار المضيف لتصفح الملفات",
      filesystemLoading: "جار تحميل المجلدات...",
      filesystemEmpty: "لا توجد مجلدات فرعية",
      chooseCurrentDirectory: "اختيار هذا المجلد",
      parentDirectory: "الانتقال إلى الدليل الأصل",
      filesystemUnavailable: "نظام الملفات غير متاح",
      conversationOnly: "محادثة · بلا دليل عمل",
      actions: {
        pin: "تثبيت المحادثة",
  ...
  workspaceSetup: {
    ...
    errors: {
      ...
      selectModel: "اختر نموذجا",
      hostDisconnected: "Host غير متصل",
      updateHostForConversationOnly: "حدّث المضيف لبدء محادثة بدون دليل عمل.",
  ...
  modelSelector: {
    title: "حدد المزود",
    runtimeTitle: "حدد إعدادات التشغيل",
    nextMessageTitle: "حدد نموذج الرسالة التالية",
    providerLabel: "المزود",
    providerLockedLabel: "المزود · مقفل",
    providerLocked: "المزود مقفل على {{provider}}",
    routeLabel: "مسار API",
    agentProvider: "مزوّد الوكيل",
    routeForProvider: "محطة ترحيل {{provider}}",
    officialDirect: "اتصال رسمي مباشر",
    searchCurrentRoute: "ابحث في نماذج هذا المسار",
    selectRoute: "حدد مسار API",
  ...
  contextWindow: {
    combinedTitle: "السياق والاستخدام",
    title: "نافذة السياق",
    shortLabel: "Context",
