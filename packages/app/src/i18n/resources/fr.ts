...
export const fr: TranslationResources = {
  ...
  composer: {
    placeholders: {
      desktop: "Décrivez une tâche ou utilisez /commands et /skills",
      mobile: "Envoyez un message ou utilisez /commands",
      fallback: "Message...",
    },
    input: {
    ...
    runtimeConfig: { label: "Configuration" },
    workspace: { locked: "Verrouillé" },
    cancel: {
    ...
    attachments: {
      ...
      queued: "En attente",
      deleteQueuedAction: "Supprimer",
      forceSendQueuedAction: "Envoyer maintenant",
      editQueuedMessage: "Modifier le message en file d'attente",
      deleteQueuedMessage: "Supprimer le message en file d'attente",
      sendQueuedMessageNow: "Forcer l'envoi du message en file d'attente",
  ...
  agentControls: {
    ...
    thinking: {
      strengthTitle: "Intensité du modèle",
      title: "Pensée",
      unknown: "Inconnu",
      extraHigh: "Très haut",
  ...
  sidebar: {
    ...
    conversation: {
      selectDirectory: "Choisir le répertoire de travail",
      directoryPlaceholder: "Rechercher un projet ou saisir un chemin d’hôte",
      directoryOpening: "Ouverture du répertoire...",
      directoryEmpty: "Aucun répertoire de projet correspondant",
      directoryOpenPath: "Ouvrir le chemin",
      directoryOpenFailed: "Impossible d’ouvrir le répertoire",
      projects: "Projets",
      filesystem: "Système de fichiers",
      filesystemPlaceholder: "Saisir un chemin d’hôte à parcourir",
      filesystemLoading: "Chargement des dossiers...",
      filesystemEmpty: "Aucun sous-dossier dans ce répertoire",
      chooseCurrentDirectory: "Choisir ce dossier",
      parentDirectory: "Aller au répertoire parent",
      filesystemUnavailable: "Système de fichiers indisponible",
      conversationOnly: "Conversation · sans répertoire de travail",
      actions: {
  ...
  workspaceSetup: {
    ...
    errors: {
      ...
      updateHostForConversationOnly:
        "Mettez à jour l'hôte pour démarrer une conversation sans répertoire de travail.",
  ...
  modelSelector: {
    ...
    runtimeTitle: "Sélectionner la configuration d'exécution",
    nextMessageTitle: "Sélectionner le modèle du prochain message",
    providerLabel: "Fournisseur",
    providerLockedLabel: "Fournisseur · Verrouillé",
    providerLocked: "Fournisseur verrouillé sur {{provider}}",
    routeLabel: "Route API",
    agentProvider: "Fournisseur d’agent",
    routeForProvider: "Relais {{provider}}",
    officialDirect: "Connexion officielle",
    searchCurrentRoute: "Rechercher les modèles de cette route",
    selectRoute: "Sélectionner une route API",
  ...
  contextWindow: {
    combinedTitle: "Contexte et utilisation",
