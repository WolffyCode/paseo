...
export const fr: TranslationResources = {
  ...
  settings: {
    ...
    vendors: {
      pageTitle: "Providers",
      syncButton: "⟳ Sync cc switch",
      colLabel: "① CLI (2 total)",
      claudeCode: "Claude Code",
      codex: "Codex",
      vendorCountSuffix: "{{count}} vendors",
      fixNote: "Vendor configuration is shared across all workspaces on this host.",
      vendorAreaLabel: "② Vendors / Relays",
      directConnect: "Direct · Anthropic official",
      defaultBadge: "Default",
      directConnectNote: "No relay",
      officialModels: "Official models",
      ccSwitchBadge: "cc switch",
      keyBadge: "key",
      addVendorButton: "＋ Add vendor (url + key)",
      ...
      modelsPreviewLabel: "③ Models · {{count}} exposed · auto-fetch",
      fetchModels: "⟳ Fetch",
      defaultModelTag: "Default",
      modelCount: "{{count}} models",
      expandVendor: "Expand",
      collapseVendor: "Collapse",
      edit: {
        title: "Edit Vendor",
        newTitle: "New Vendor",
        ...
        apiKey: "API Key",
        baseUrl: "Base URL",
        baseUrlTip: "💡 Enter a Claude API-compatible endpoint. Do not include a trailing slash.",
        advancedTitle: "Advanced options",
        apiFormat: "API format",
        apiFormatAnthropicLabel: "Anthropic Messages (native)",
        apiFormatOpenaiLabel: "OpenAI",
        apiFormatHint: "Input format for the vendor API",
        authStyle: "Auth field",
        authStyleAnthropicAuthTokenLabel: "ANTHROPIC_AUTH_TOKEN (default)",
        authStyleAnthropicApiKeyLabel: "ANTHROPIC_API_KEY",
        authStyleOpenaiApiKeyLabel: "OPENAI_API_KEY",
        authStyleHint: "Which env var to write the key into",
        fallbackModel: "Fallback model",
        fallbackModelHint:
          "Used for requests not assigned to a role; recommended when using third-party endpoints",
        configJsonTitle: "Config · config JSON",
        showApiKey: "Show API key",
        hideApiKey: "Hide API key",
        writeToCommon: "Write to common config",
        editCommonConfig: "Edit common config ›",
        qtHideAiSignature: "Hide AI signature",
        qtTeammates: "Teammates mode",
        qtEnableToolSearch: "Enable Tool Search",
        qtMaxThinking: "Max thinking",
        qtDisableAutoUpgrade: "Disable auto-upgrade",
        formatButton: "✦ Format",
        jsonNote:
          "Role mappings (Opus/Sonnet/Haiku → specific models) live here; advanced users can edit",
        models: {
          sectionTitle: "Modèles · lesquels exposer",
          sectionSubtitle:
            "Seuls les modèles cochés apparaissent dans le sélecteur de conversation",
          fetchButton: "⤓ Récupérer la liste des modèles",
          searchPlaceholder: "🔍 Rechercher",
          fetchError: "Échec de récupération : {{reason}}",
          fetchErrorManualHint: "Vous pouvez ajouter des modèles manuellement.",
          manualAddPlaceholder: "ID du modèle",
          manualAddButton: "＋",
          manualAddAccessibilityLabel: "Ajouter un modèle",
          setDefault: "Définir par défaut",
          isDefault: "● Par défaut",
          exposedCountFooter: "Exposés {{exposed}} / {{total}} modèles",
        },
        ccSwitchTag: "from cc switch",
        save: "💾 Save",
        saving: "Saving...",
      },
      sync: {
        title: "⟳ Sync from cc switch",
        subtitle:
          "Reads ~/.cc-switch/cc-switch.db (read-only) · Maps to CLI by app_type · Matched by cc switch id, won't overwrite your edits",
        tabLabel: "{{name}} ({{count}})",
        selectHeading: "Select vendors to import/update",
        selectAll: "Select all",
        selectNone: "Select none",
        statusNew: "New",
        statusUpdate: "Update · key/url changed",
        statusSame: "Same",
        modelCount: "{{count}} models",
        footnote:
          "Already-imported vendors you've edited locally won't be overwritten · Vendors not in cc switch are left untouched",
        footerSummary:
          "Selected {{selected}} / {{total}} · {{newCount}} new · {{updateCount}} updates",
  ...
  conversation: {
    modelPicker: {
      directConnect: "Direct · Anthropic Officiel",
      providerLocked: "🔒 Verrouillé",
      noModel: "Aucun modèle",
      providerSection: "① Fournisseur · Verrouillé",
      vendorSection: "② Vendeur · Commutable",
      modelSection: "③ Modèle",
      manageVendors: "⚙ Gérer les fournisseurs…",
      back: "Retour",
    },
  },
};
