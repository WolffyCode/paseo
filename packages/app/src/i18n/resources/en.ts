export const en = {
  ...
  composer: {
    placeholders: {
      desktop: "Describe a task, / for commands",
      mobile: "Message or use /commands",
      fallback: "Message...",
    },
    input: {
    ...
    runtimeConfig: { label: "Run config" },
    ...
    attachments: {
      ...
      queued: "Queued",
      deleteQueuedAction: "Delete",
      forceSendQueuedAction: "Send now",
      editQueuedMessage: "Edit queued message",
      deleteQueuedMessage: "Delete queued message",
      sendQueuedMessageNow: "Force send queued message",
  ...
  sidebar: {
    ...
    conversation: {
      ...
      directoryPlaceholder: "Search projects or enter a host path",
      directoryOpening: "Opening directory...",
      directoryEmpty: "No matching project directories",
      directoryOpenPath: "Open path",
      directoryOpenFailed: "Unable to open directory",
      projects: "Projects",
      filesystem: "File system",
      filesystemPlaceholder: "Enter a host path to browse",
      filesystemLoading: "Loading folders...",
      filesystemEmpty: "No subfolders in this directory",
      chooseCurrentDirectory: "Choose this folder",
      parentDirectory: "Go to parent directory",
      filesystemUnavailable: "File system unavailable",
      conversationOnly: "Conversation · no working directory",
      actions: {
  ...
  workspaceSetup: {
    ...
    errors: {
      ...
      updateHostForConversationOnly:
        "Update the host to start a conversation without a working directory.",
  ...
  modelSelector: {
    ...
    runtimeTitle: "Select runtime configuration",
    nextMessageTitle: "Select the model for the next message",
    providerLabel: "Provider",
    providerLockedLabel: "Provider · Locked",
    providerLocked: "Provider locked to {{provider}}",
    routeLabel: "API route",
    agentProvider: "Agent provider",
    routeForProvider: "{{provider}} relay",
    officialDirect: "Official direct",
    searchCurrentRoute: "Search models on this route",
    selectRoute: "Select API route",
  ...
  contextWindow: {
    combinedTitle: "Context and usage",
