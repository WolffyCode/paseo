export const en = {
  ...
  settings: {
    ...
    vendors: {
      ...
      edit: {
        ...
        models: {
          sectionTitle: "Models · which to expose",
          sectionSubtitle: "Only checked models appear in the conversation switcher",
          fetchButton: "⤓ Fetch model list",
          searchPlaceholder: "🔍 Search",
          fetchError: "Fetch failed: {{reason}}",
          fetchErrorManualHint: "You can add models manually below.",
          manualAddPlaceholder: "Model ID (e.g. gpt-4o)",
          manualAddButton: "＋",
          manualAddAccessibilityLabel: "Add model",
          setDefault: "Set default",
          isDefault: "● Default",
          exposedCountFooter:
            "Exposed {{exposed}} / {{total}} models (relay may support multiple families — only expose what you want)",
        },
  ...
  conversation: {
    modelPicker: {
      ...
      noModel: "No model",
      providerSection: "① Provider · Locked",
      vendorSection: "② Vendor · Switchable",
      modelSection: "③ Model",
