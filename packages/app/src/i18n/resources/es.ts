...
export const es: TranslationResources = {
  ...
  composer: {
    placeholders: {
      desktop: "Describe una tarea o usa /commands y /skills",
      mobile: "Envía un mensaje o usa /commands",
      fallback: "Mensaje...",
    },
    input: {
    ...
    runtimeConfig: { label: "Configuración" },
    workspace: { locked: "Bloqueado" },
    cancel: {
    ...
    attachments: {
      ...
      queued: "En cola",
      deleteQueuedAction: "Eliminar",
      forceSendQueuedAction: "Enviar ahora",
      editQueuedMessage: "Editar mensaje en cola",
      deleteQueuedMessage: "Eliminar mensaje en cola",
      sendQueuedMessageNow: "Forzar envío del mensaje en cola",
  ...
  agentControls: {
    ...
    thinking: {
      strengthTitle: "Intensidad del modelo",
      title: "Pensamiento",
      unknown: "Desconocido",
  ...
  sidebar: {
    ...
    conversation: {
      selectDirectory: "Seleccionar directorio de trabajo",
      directoryPlaceholder: "Busca proyectos o introduce una ruta del host",
      directoryOpening: "Abriendo directorio...",
      directoryEmpty: "No hay directorios de proyecto coincidentes",
      directoryOpenPath: "Abrir ruta",
      directoryOpenFailed: "No se puede abrir el directorio",
      projects: "Proyectos",
      filesystem: "Sistema de archivos",
      filesystemPlaceholder: "Introduce una ruta del host para explorar",
      filesystemLoading: "Cargando carpetas...",
      filesystemEmpty: "No hay subcarpetas en este directorio",
      chooseCurrentDirectory: "Elegir esta carpeta",
      parentDirectory: "Ir al directorio padre",
      filesystemUnavailable: "Sistema de archivos no disponible",
      conversationOnly: "Conversación · sin directorio de trabajo",
      actions: {
  ...
  workspaceSetup: {
    ...
    errors: {
      ...
      selectModel: "Selecciona un modelo",
      hostDisconnected: "Hostno está conectado",
      updateHostForConversationOnly:
        "Actualiza el host para iniciar una conversación sin directorio de trabajo.",
  ...
  modelSelector: {
    ...
    runtimeTitle: "Seleccionar configuración de ejecución",
    nextMessageTitle: "Seleccionar el modelo para el próximo mensaje",
    providerLabel: "Proveedor",
    providerLockedLabel: "Proveedor · Bloqueado",
    providerLocked: "Proveedor bloqueado en {{provider}}",
    routeLabel: "Ruta de API",
    agentProvider: "Proveedor de agente",
    routeForProvider: "Intermediario de {{provider}}",
    officialDirect: "Conexión oficial",
    searchCurrentRoute: "Buscar modelos en esta ruta",
    selectRoute: "Seleccionar ruta de API",
  ...
  settings: {
    ...
    shortcuts: {
      ...
      help: {
        ...
        openFile: "Abrir archivo",
        newSideChat: "Nuevo chat lateral",
        toggleToolPanel: "Alternar panel de herramientas",
    ...
    host: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Este anfitrión está desconectado.Helmse vuelve a conectar automáticamente; espere hasta que vuelva a estar en línea antes de reiniciar.",
          requestFailedTitle: "Error",
          requestFailedMessage:
            "No se pudo enviar la solicitud de reinicio.Helmse vuelve a conectar automáticamente; inténtelo nuevamente una vez que el host se muestre en línea.",
          dialogFailedMessage:
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "Helm supervisa el proceso y asigna un puerto vía $PASEO_PORT",
        actions: {
          add: "Agregar guión",
          edit: "Editar",
          remove: "Eliminar",
