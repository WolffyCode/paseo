...
export const es: TranslationResources = {
  ...
  settings: {
    ...
    vendors: {
      ...
      edit: {
        ...
        models: {
          sectionTitle: "Modelos · cuáles exponer",
          sectionSubtitle: "Solo los modelos marcados aparecen en el selector de conversación",
          fetchButton: "⤓ Obtener lista de modelos",
          searchPlaceholder: "🔍 Buscar",
          fetchError: "Error al obtener: {{reason}}",
          fetchErrorManualHint: "Puedes agregar modelos manualmente.",
          manualAddPlaceholder: "ID del modelo",
          manualAddButton: "＋",
          manualAddAccessibilityLabel: "Agregar modelo",
          setDefault: "Establecer como predeterminado",
          isDefault: "● Predeterminado",
          exposedCountFooter: "Expuestos {{exposed}} / {{total}} modelos",
        },
  ...
  conversation: {
    modelPicker: {
      directConnect: "Directo · Anthropic Oficial",
      providerLocked: "🔒 Bloqueado",
      noModel: "Sin modelo",
      providerSection: "① Proveedor · Bloqueado",
      vendorSection: "② Vendedor · Intercambiable",
      modelSection: "③ Modelo",
