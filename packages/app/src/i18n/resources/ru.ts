...
export const ru: TranslationResources = {
  ...
  composer: {
    placeholders: {
      desktop: "Опишите задачу или используйте /commands и /skills",
      mobile: "Напишите сообщение или используйте /commands",
      fallback: "Сообщение...",
    },
    input: {
    ...
    runtimeConfig: { label: "Настройки запуска" },
    workspace: { locked: "Заблокировано" },
    cancel: {
    ...
    attachments: {
      ...
      queued: "В очереди",
      deleteQueuedAction: "Удалить",
      forceSendQueuedAction: "Отправить сейчас",
      editQueuedMessage: "Изменить сообщение в очереди",
      deleteQueuedMessage: "Удалить сообщение из очереди",
      sendQueuedMessageNow: "Принудительно отправить сообщение из очереди",
  ...
  agentControls: {
    ...
    thinking: {
      strengthTitle: "Интенсивность модели",
      title: "мышление",
      unknown: "Неизвестный",
  ...
  sidebar: {
    ...
    conversation: {
      selectDirectory: "Выбрать рабочий каталог",
      directoryPlaceholder: "Найдите проект или введите путь хоста",
      directoryOpening: "Открытие каталога...",
      directoryEmpty: "Подходящие каталоги проектов не найдены",
      directoryOpenPath: "Открыть путь",
      directoryOpenFailed: "Не удалось открыть каталог",
      projects: "Проекты",
      filesystem: "Файловая система",
      filesystemPlaceholder: "Введите путь хоста для просмотра",
      filesystemLoading: "Загрузка папок...",
      filesystemEmpty: "В этом каталоге нет подпапок",
      chooseCurrentDirectory: "Выбрать эту папку",
      parentDirectory: "Перейти в родительский каталог",
      filesystemUnavailable: "Файловая система недоступна",
      conversationOnly: "Беседа · без рабочего каталога",
      actions: {
  ...
  workspaceSetup: {
    ...
    errors: {
      ...
      selectModel: "Выберите модель",
      hostDisconnected: "Host не подключен",
      updateHostForConversationOnly: "Обновите host, чтобы начать разговор без рабочего каталога.",
  ...
  modelSelector: {
    ...
    runtimeTitle: "Выберите конфигурацию запуска",
    nextMessageTitle: "Выберите модель для следующего сообщения",
    providerLabel: "Провайдер",
    providerLockedLabel: "Провайдер · Заблокирован",
    providerLocked: "Провайдер зафиксирован: {{provider}}",
    routeLabel: "Маршрут API",
    agentProvider: "Поставщик агента",
    routeForProvider: "Прокси {{provider}}",
    officialDirect: "Официальное подключение",
    searchCurrentRoute: "Поиск моделей этого маршрута",
    selectRoute: "Выберите маршрут API",
    selectModel: "Выберите модель",
  ...
  contextWindow: {
    combinedTitle: "Контекст и лимиты",
