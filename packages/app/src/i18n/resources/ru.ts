...
export const ru: TranslationResources = {
  ...
  onboarding: {
    ...
    connecting: {
      managedDaemon: "Запускается встроенный daemon на этом настольном хосте.",
      loadingHosts: "Загрузка сохраненных хостов.",
      foundHost: "Хост найден. Открывается рабочая область.",
      searching: "Поиск доступного хоста.",
    },
    picker: {
      title: "Выберите хост",
      subtitle: "Используйте существующий хост или подключите новый.",
    },
    error: {
      title: "Не удалось подключиться к хосту",
      body: "Повторите попытку или добавьте хост вручную, чтобы продолжить.",
    },
  },
  modelSelector: {
