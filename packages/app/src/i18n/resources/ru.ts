...
export const ru: TranslationResources = {
  ...
  settings: {
    ...
    vendors: {
      ...
      edit: {
        ...
        models: {
          sectionTitle: "Модели · какие показывать",
          sectionSubtitle: "Только отмеченные модели появляются в переключателе разговоров",
          fetchButton: "⤓ Получить список моделей",
          searchPlaceholder: "🔍 Поиск",
          fetchError: "Ошибка получения: {{reason}}",
          fetchErrorManualHint: "Вы можете добавить модели вручную.",
          manualAddPlaceholder: "ID модели",
          manualAddButton: "＋",
          manualAddAccessibilityLabel: "Добавить модель",
          setDefault: "Сделать по умолчанию",
          isDefault: "● По умолчанию",
          exposedCountFooter: "Показаны {{exposed}} / {{total}} моделей",
        },
  ...
  conversation: {
    modelPicker: {
      directConnect: "Прямое · Anthropic Официальный",
      providerLocked: "🔒 Заблокирован",
      noModel: "Нет модели",
      providerSection: "① Провайдер · Заблокирован",
      vendorSection: "② Поставщик · Переключаемый",
      modelSection: "③ Модель",
      manageVendors: "⚙ Управление поставщиками…",
      back: "Назад",
    },
  },
};
