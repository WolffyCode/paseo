...
export const zhCN: TranslationResources = {
  ...
  settings: {
    ...
    vendors: {
      pageTitle: "提供方",
      syncButton: "⟳ 一键同步 cc switch",
      colLabel: "① 提供方（仅 2 个）",
      claudeCode: "Claude Code",
      codex: "Codex",
      vendorCountSuffix: "{{count}} 个供应商",
      fixNote: "供应商配置在此 Host 的所有工作区之间共享。",
      vendorAreaLabel: "② 模型供应商 / 中转站",
      directConnect: "直连 · Anthropic 官方登录",
      defaultBadge: "默认",
      directConnectNote: "不走中转站",
      officialModels: "官方模型",
      ccSwitchBadge: "cc switch",
      keyBadge: "key",
      addVendorButton: "＋ 新增供应商（手动填 url + key）",
      editVendor: "编辑供应商",
      deleteVendor: "删除供应商",
      deleteConfirmTitle: "删除供应商",
      deleteConfirmMessage: "确定要删除该供应商吗？",
      deleteConfirmOk: "删除",
      deleteConfirmCancel: "取消",
      modelsPreviewLabel: "③ 模型 · 放出来 {{count}} 个 · 自动拉取",
      fetchModels: "⟳ 拉取",
      defaultModelTag: "默认",
      modelCount: "{{count}} 模型",
      expandVendor: "展开",
      ...
      edit: {
        ...
        advancedTitle: "高级选项",
        apiFormat: "API 格式",
        apiFormatAnthropicLabel: "Anthropic Messages (原生)",
        apiFormatOpenaiLabel: "OpenAI",
        apiFormatHint: "选择供应商 API 的输入格式",
        authStyle: "认证字段",
        authStyleAnthropicAuthTokenLabel: "ANTHROPIC_AUTH_TOKEN（默认）",
        authStyleAnthropicApiKeyLabel: "ANTHROPIC_API_KEY",
        authStyleOpenaiApiKeyLabel: "OPENAI_API_KEY",
        authStyleHint: "key 写入哪个认证环境变量",
        fallbackModel: "默认兜底模型",
        fallbackModelHint: "未明确落到角色的请求用它；走第三方/中转端点时建议填",
        configJsonTitle: "配置 · config JSON",
        showApiKey: "显示 API Key",
        hideApiKey: "隐藏 API Key",
        writeToCommon: "写入通用配置",
        editCommonConfig: "编辑通用配置 ›",
        qtHideAiSignature: "隐藏 AI 署名",
        qtTeammates: "Teammates 模式",
        qtEnableToolSearch: "启用 Tool Search",
        qtMaxThinking: "最大强度思考",
        qtDisableAutoUpgrade: "禁用自动升级",
        formatButton: "✦ 格式化",
        jsonNote: "角色映射(Opus/Sonnet/Haiku→具体模型)就在这份 JSON 里，高级用户可改",
        models: {
          sectionTitle: "模型 · 放出来哪些",
          sectionSubtitle: "勾选的才出现在对话切换器里",
          fetchButton: "⤓ 获取模型列表",
          searchPlaceholder: "🔍 搜索",
          fetchError: "拉取失败：{{reason}}",
          fetchErrorManualHint: "可以手动添加模型。",
          manualAddPlaceholder: "模型 ID（如 gpt-4o）",
          manualAddButton: "＋",
          manualAddAccessibilityLabel: "添加模型",
          setDefault: "设默认",
          isDefault: "● 默认",
          exposedCountFooter:
            "已放出 {{exposed}} / {{total}} 个模型（中转同时支持 Claude+GLM，只放想要的）",
        },
        ccSwitchTag: "来自 cc switch",
        save: "💾 保存",
        saving: "保存中...",
      },
      sync: {
        title: "⟳ 从 cc switch 同步供应商",
        subtitle:
          "读取 ~/.cc-switch/cc-switch.db（只读）· 按 app_type 映射到对应 CLI · 按 cc switch id 关联，不覆盖你改过的",
        tabLabel: "{{name}}（{{count}}）",
        selectHeading: "勾选要导入/更新的供应商",
        selectAll: "全选",
        selectNone: "全不选",
        statusNew: "新增",
        statusUpdate: "更新 · key/url 有变化",
        statusSame: "相同",
        modelCount: "{{count}} 模型",
        footnote:
          '已导入但你本地改过的不会被覆盖（标"更新"的可逐项确认）· 不在 cc switch 里的本地供应商保留不动',
        footerSummary: "已选 {{selected}} / {{total}} · {{newCount}} 新增 · {{updateCount}} 更新",
        importButton: "导入所选",
        loading: "加载中...",
        errorPrefix: "错误：",
        applyFailed: "导入失败",
  ...
  conversation: {
    modelPicker: {
      directConnect: "直连 · Anthropic 官方",
      providerLocked: "🔒 不可换",
      noModel: "未选模型",
      providerSection: "① 提供方 · 锁定",
      vendorSection: "② 中转站 · 可切换",
      modelSection: "③ 模型",
      manageVendors: "⚙ 管理供应商…",
      back: "返回",
    },
