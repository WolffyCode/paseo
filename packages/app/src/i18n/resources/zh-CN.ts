...
export const zhCN: TranslationResources = {
  ...
  composer: {
    ...
    attachments: {
      ...
      queued: "待发",
      deleteQueuedAction: "删除",
      forceSendQueuedAction: "强制发送",
      editQueuedMessage: "编辑排队消息",
      deleteQueuedMessage: "删除排队消息",
      sendQueuedMessageNow: "强制发送排队消息",
      openImage: "打开图片附件",
      removeImage: "移除图片附件",
  ...
  agentControls: {
    ...
    mode: {
      title: "运行模式",
      searchPlaceholder: "搜索运行模式...",
      selectWithValue: "选择运行模式（{{value}}）",
      labels: {
        alwaysAsk: "始终询问",
        autoMode: "自动模式",
        acceptFileEdits: "自动接受编辑",
        plan: "规划模式",
        bypass: "跳过确认",
  ...
  sidebar: {
    ...
    conversation: {
      ...
      directoryPlaceholder: "搜索项目或输入 Host 路径",
      directoryOpening: "正在打开目录...",
      directoryEmpty: "没有匹配的项目目录",
      directoryOpenPath: "打开路径",
      directoryOpenFailed: "无法打开目录",
      projects: "项目目录",
      filesystem: "文件系统",
      filesystemPlaceholder: "输入 Host 路径浏览文件系统",
      filesystemLoading: "正在加载文件夹...",
      filesystemEmpty: "当前目录没有子文件夹",
      chooseCurrentDirectory: "选择此目录",
      parentDirectory: "返回上级目录",
      filesystemUnavailable: "文件系统不可用",
      conversationOnly: "对话 · 未选择工作目录",
      actions: {
        pin: "置顶对话",
        unpin: "取消置顶对话",
        rename: "重命名对话",
  ...
  workspaceSetup: {
    ...
    errors: {
      ...
      selectModel: "请选择模型",
      hostDisconnected: "Host 未连接",
      updateHostForConversationOnly: "请更新 Host，以便在不选择工作目录时开始对话。",
  ...
  modelSelector: {
    title: "选择提供方",
    runtimeTitle: "选择运行配置",
    nextMessageTitle: "选择下一条消息使用的模型",
    providerLabel: "提供方",
    providerLockedLabel: "提供方 · 已锁定",
    providerLocked: "提供方已锁定为 {{provider}}",
    routeLabel: "中转站",
    agentProvider: "Agent 提供方",
    routeForProvider: "{{provider}} 中转站",
    officialDirect: "官方直连",
    searchCurrentRoute: "搜索当前中转站的模型",
    selectRoute: "选择中转站",
    selectModel: "选择模型",
